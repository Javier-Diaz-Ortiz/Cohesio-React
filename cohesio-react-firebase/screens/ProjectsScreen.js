...
const ProjectsScreen = (props) => { //TODO: change the collection name to projects and that things 
  ...
  return (
          <ScrollView>
              <View>
                  <TouchableOpacity style={styles.button} onPress={() => props.navigation.navigate('CreateReview')}> 
                          ...
                          <ListItem
                              ...
                              onPress={() => 
                                  props.navigation.navigate('ReviewScreen', {
                                      projectId: project.id // Pasa el ID del project a la pantalla de detalles para mostrar el project con ese id 
                              })}
                             >
                              <ListItem.Chevron />
